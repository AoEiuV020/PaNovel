 ...
 */
internal class SimpleReader(override var ctx: Context, novel: Novel, parent: ViewGroup, requester: TextRequester, config: Config) : BaseNovelReader(novel, requester, config), ConfigChangedListener {

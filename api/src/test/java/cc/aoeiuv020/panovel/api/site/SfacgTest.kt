...
class SfacgTest : BaseNovelContextText(Sfacg::class) {
    ...
    fun detail() {
        ...
        detail("114367", "114367", "我的学生们都是问题大小姐", "诡话连篇",
                "http://rs.sfacg.com/web/novel/images/NovelCover/Big/2020/03/bb852e36-4905-4825-ad4f-e7ffd69cbe08.jpg",
                "本书原名《我的学生们都是病娇大小姐》。\n" +
                        "“同学们，下课了！”我站在讲台上整理了一下衣服：“所以你们能把我的手铐打开吗……”\n" +
    ...
    fun vip() {
        content("/vip/c/2517034/",
            "“我明白了。”一名返老还童的修士一指秦钩胸有成竹，语气笃定道：“此人绝非与我们一样的外来修士，否则他不可能还维持这样的实力，他一定是就是秘境给我们的第一重考验，只要我们通力合作一起战胜他，就能顺利...",
            "“我明白了。”一名返老还童的修士一指秦钩胸有成竹，语气笃定道：“此人绝非与我们一样的外来修士，否则他不可能还维持这样的实力，他一定是就是秘境给我们的第一重考验，只要我们通力合作一起战胜他，就能顺利...",
            1)
    }
}

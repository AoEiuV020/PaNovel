...
abstract class BaseItemListAdapter(context: Context)
    : RecyclerAdapter<Novel>(context) {

    override fun onViewRecycled(holder: BaseViewHolder<Novel>) {
        // header和footer会强转失败，
...
open class DefaultItemListAdapter(context: Context, private val presenter: BaseItemListPresenter<*, DefaultItemPresenter>,
    ...
    override fun onCreateBaseViewHolder(parent: ViewGroup?, viewType: Int): BaseViewHolder<Novel>
